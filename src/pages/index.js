	...
	return (
		<Layout showContactForm>
			...
			<section id="wrapper">
					...
					<div className="inner">
						...
						<div className="content">
							...
							<p>
								...
								developing inidivual web- and mobile applications for clients
								and employers for over 14 years now.{' '}
					...
					<div className="inner">
						...
						<div className="content">
							...
							<p style={{ marginBottom: '1em' }}>
								...
								business. You can also hire me as an expert on your software
								team.
				...
				<section id="three" className="wrapper spotlight style3">
					<div className="inner">
						...
						<div className="content">
							...
							<p>
								I've always been fascinated by technologies of all kinds. That
								is why I aimed for an apprenticeship as a media designer at an
								early stage. There I learned the basics of development as well
								as design. It soon became clear to me that I wanted to delve
								much deeper into the topics of computer science.
							</p>
							<p>
							...
							<p>
								Technology is my passion, I'm a maker by heart and love to
								tinker with embedded devices in my spare time.
							</p>
						</div>
					</div>
				</section>
					...
					<div className="inner">
						...
						<section className="features">
							...
							<article>
								<div className="image">
									<img
										src={storyboardPicture}
										alt="Storyboard iOS Application"
									/>
								</div>
				...
				<section id="six" className="wrapper style3">
					<div className="inner">
						<h2 className="major">Blog</h2>
						<p>
							This is my notebook. Mainly a place for myself to keep things in
							written form so i can remember. It's not necessarily work related,
							but i'm still glad if you find something interesting.
						</p>
						<section className="features">
							{data.allMarkdownRemark.edges.map(post => {
								...
								return (
									<article key={`${path}`}>
										<div className="image">
											<img src={postPlaceholder} alt={title} />
										</div>
										<h3 className="major">
											<Link to={path}>{title}</Link>
										</h3>
										<p>{description}</p>
										<Link to={path} className="special">
											Read
										</Link>
									</article>
								)
