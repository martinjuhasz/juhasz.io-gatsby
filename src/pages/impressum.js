	...
	<Layout fullMenu>
		<section id="wrapper">
			<header>
				<div className="inner">
					<h2>Impressum</h2>
					<p>Legal Notice in German</p>
				</div>
			</header>

			<div className="wrapper">
				<div className="inner">
					<h3 className="major">Angaben gemäß § 5 TMG</h3>
					<p>
						Martin Juhasz
						<br />
						juhasz.io
					...
					<h3 className="major">Kontakt</h3>
					<p>
						Telefon: +49 1716464863 <br />
						E-Mail: martin@juhasz.io
					</p>
					...
					<h3 className="major">Haftung f&uuml;r Inhalte</h3>
					<p>
					...
					<h3 className="major">Haftung f&uuml;r Links</h3>
					<p>
					...
					<h3 className="major">Urheberrecht</h3>
					<p>
					...
					<h3 className="major">Attribution</h3>
					<p>
						This website is based on a{' '}
						<a href="https://appseed.us/apps/gatsbyjs/gatsby-html5up-solidstate">
							Gatsby Template from AppSeed
						</a>
						. You can find my modifications and the source code for this site{' '}
						<a href="https://github.com/martinjuhasz/juhasz.io">on GitHub</a>.
					</p>
				</div>
			</div>
		</section>
